                    ...
                    <img src="../../global/images/writers/<?php echo $dp ?>" alt="">
                        ...
                        <p class="writer_can_be_reached_at"><b><?php echo $by ?></b> can be reached at: </span>
                            <div class="writer_links">
                                <a target="_blank" href="mailto:<?php echo $mail ?>"><img src="../images/email_square.png" alt=""></a>
                                <a target="_blank" href="<?php echo $fb ?>" ><img src="../images/fb_square.png" alt=""></a>
                                <a target="_blank" href="<?php echo $twitter ?>"><img src="../images/twitter_square.png" alt=""></a>
                                <a target="_blank" href="<?php echo $insta ?>"><img src="../images/insta_square.png" alt=""></a>
                            </div>
                        </p>
                    </div>
                </div>
