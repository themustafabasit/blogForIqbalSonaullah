...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="../css/localUserArticle.css">
        ...
        <header>
            <div class="header_row_1">
                ...
                <div class="row_1_right_side">
                    <li class="top_right_links_container">
                        <div class="skew1"><a href="../Login/">login</a></div>
                    </li>
                    <li class="top_right_links_container">
            ...
            <div class="header_row_4">
                <div class="in_fourth_line_li_holder">
                    ...
                    <li class="in_fourth_line_li"><a  href="../Login/" class="in_fourth_line_anchor">login</a></li>
